...
defmodule AriaPlanner.Domains.Interactivity.Commands.MathSub do
  @moduledoc """
  Command: c_math_sub(node_id, a_socket, b_socket, value_socket)

  Executes math/sub operation: value = a - b
  ...
  def c_math_sub(state, node_id, a_socket, b_socket, value_socket) do
  ...
  defp subtract_values(a, b) when is_number(a) and is_number(b), do: a - b
  defp subtract_values({a1, a2}, {b1, b2}), do: {a1 - b1, a2 - b2}
  defp subtract_values({a1, a2, a3}, {b1, b2, b3}), do: {a1 - b1, a2 - b2, a3 - b3}
  defp subtract_values({a1, a2, a3, a4}, {b1, b2, b3, b4}), do: {a1 - b1, a2 - b2, a3 - b3, a4 - b4}

  defp subtract_values(a, b) when is_tuple(a) and is_tuple(b) do
    # Handle matrix types (float2x2, float3x3, float4x4)
    Tuple.to_list(a)
  ...
  defp subtract_values(a, b) do
    # Fallback: try to subtract as numbers
    a - b
  rescue
