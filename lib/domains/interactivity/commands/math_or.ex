...
defmodule AriaPlanner.Domains.Interactivity.Commands.MathOr do
  @moduledoc """
  Command: c_math_or(node_id, ...)

  Executes math/or operation.
  ...
  def c_math_or(state, node_id, a_socket, b_socket, value_socket) do
    with :ok <- MathHelpers.check_graph_active(state),
      ...
      # Compute or (component-wise)
      result = MathHelpers.apply_binary_op(a, b, &MathHelpers.or_op/2)
