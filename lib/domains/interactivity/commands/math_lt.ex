...
defmodule AriaPlanner.Domains.Interactivity.Commands.MathLt do
  @moduledoc """
  Command: c_math_lt(node_id, a_socket, b_socket, value_socket)

  Executes math/lt operation: value = a < b
  Compares a < b component-wise using MathHelpers.lt_op.
  ...
  def c_math_lt(state, node_id, a_socket, b_socket, value_socket) do
    with :ok <- MathHelpers.check_graph_active(state),
      ...
      # Compare a < b using MathHelpers.lt_op for component-wise operation
      result = MathHelpers.apply_binary_op(a, b, &MathHelpers.lt_op/2)
