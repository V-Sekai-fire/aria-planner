...
=======
  Command: c_math_gt(node_id, a_socket, b_socket, value_socket)

  Executes math/gt operation: value = a > b
  Compares a > b component-wise using MathHelpers.gt_op.
...
=======
  def c_math_gt(state, node_id, a_socket, b_socket, value_socket) do
    with :ok <- MathHelpers.check_graph_active(state),
      ...
      # Compare a > b using MathHelpers.gt_op for component-wise operation
      result = MathHelpers.apply_binary_op(a, b, &MathHelpers.gt_op/2)
