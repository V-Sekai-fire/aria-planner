...
defmodule AriaPlanner.Domains.Interactivity.Commands.MathEq do
  @moduledoc """
  Command: c_math_eq(node_id, ...)

  Executes math/eq operation.
  ...
  def c_math_eq(state, node_id, a_socket, b_socket, value_socket) do
