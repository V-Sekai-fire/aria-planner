...
defmodule AriaPlanner.Domains.Interactivity.Commands.FlowThrottle do
  @moduledoc """
  Command: c_flow_throttle(node_id, ...)

  Executes flow/throttle operation.
