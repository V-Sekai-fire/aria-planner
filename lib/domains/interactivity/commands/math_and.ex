...
defmodule AriaPlanner.Domains.Interactivity.Commands.MathAnd do
  @moduledoc """
  Command: c_math_and(node_id, ...)

  Executes math/and operation.
  ...
  def c_math_and(state, node_id, a_socket, b_socket, value_socket) do
    with :ok <- MathHelpers.check_graph_active(state),
      ...
      # Compute bitwise/boolean AND
      result = if is_integer(a) and is_integer(b), do: Bitwise.band(a, b), else: a and b
