...
defmodule AriaPlanner.Domains.Interactivity.Commands.MathRotate2D do
  @moduledoc """
  Command: c_math_rotate_2d(node_id, ...)

  Executes math/rotate2D operation.
  ...
  def c_math_rotate_2d(state, node_id, a_socket, b_socket, value_socket) do
