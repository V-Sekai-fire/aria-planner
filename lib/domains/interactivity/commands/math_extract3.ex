...
defmodule AriaPlanner.Domains.Interactivity.Commands.MathExtract3 do
  @moduledoc """
  Command: c_math_extract3(node_id, ...)

  Executes math/extract3 operation.
  ...
  @spec c_math_extract3(state :: map(), node_id :: String.t(), a_socket :: String.t(), value_socket :: String.t()) ::
          {:ok, map()} | {:error, String.t()}
  def c_math_extract3(state, node_id, a_socket, value_socket) do
